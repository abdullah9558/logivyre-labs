...
export const metadata:Metadata={metadataBase:new URL('https://logivyrelabs.com'),title:{default:'Logivyre Labs — Useful software, thoughtfully engineered',template:'%s — Logivyre Labs'},description:'An independent software studio building products for personal finance, quality engineering and modern retail.',icons:{icon:[{url:'/logivyre-mark-light.png',media:'(prefers-color-scheme: light)'},{url:'/logivyre-mark-dark.png',media:'(prefers-color-scheme: dark)'}],apple:'/logivyre-mark-light.png'},openGraph:{title:'Logivyre Labs',description:'Useful software, thoughtfully engineered.',images:['/projects/mera-markaz-thumbnail.png']}};
